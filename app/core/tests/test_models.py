...
class ModelTests(TestCase):
    ...
    def test_report_file_name_uuid(self, mock_uuid):
        """Test generating image path"""
        uuid = 'test-uuid'
        mock_uuid.return_value = uuid
        file_path = models.report_image_file_path(None, 'example.jpg')

        self.assertEqual(file_path, f'uploads/report/{uuid}.jpg')
